...
def get_video_info(url):
    ...
    data = api_get(f"https://rutube.ru/api/video/{video_id}/")
    ...
    season_match = re.search(r"(\d+)\s*сезон", title, re.IGNORECASE)

    episode_match = re.search(r"(\d+)\s*серия", title, re.IGNORECASE)
